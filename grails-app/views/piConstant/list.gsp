...
<body>
<a href="#list-piConstant" class="skip" tabindex="-1"><g:message code="default.link.skip.label"
...
<div id="list-piConstant" class="content scaffold-list" role="main">
    ...
    <table>
        ...
        <tr>
            ...
            <g:sortableColumn property="numerator"
                              title="${message(code: 'piConstant.numerator.label', default: 'Numerator')}"/>

            <g:sortableColumn property="sum" title="${message(code: 'piConstant.sum.label', default: 'Sum')}"/>

            <g:sortableColumn property="temp" title="${message(code: 'piConstant.temp.label', default: 'Temp')}"/>
        ...
        <g:each in="${piConstantInstanceList}" status="i" var="piConstantInstance">
            <tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
                ...
                <td>${fieldValue(bean: piConstantInstance, field: "temp")}</td>
