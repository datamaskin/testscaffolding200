...
<html>
	...
	<body>
        ...
        <a href="#create-piConstant" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		<div id="create-piConstant" class="content scaffold-create" role="main">
